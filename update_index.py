...
def _render_pros_cons(pros: List[str], cons: List[str]) -> str:
    ...
    def _items(points: List[str], color: str, symbol: str) -> str:
        lines = "\n".join(
            f'                                <div style="display:flex;gap:10px;font-size:13px;color:var(--muted);align-items:flex-start;">'
    ...
    return f"""                        <div>
                            <div style="font-size:9px;letter-spacing:.1em;text-transform:uppercase;color:var(--muted);margin-bottom:10px;">Переваги</div>
                            <div style="display:flex;flex-direction:column;gap:8px;">
{_items(pros, "#10b981", "✓")}
                            </div>
                        </div>
                        <div>
                            <div style="font-size:9px;letter-spacing:.1em;text-transform:uppercase;color:var(--muted);margin-bottom:10px;">Ризики</div>
                            <div style="display:flex;flex-direction:column;gap:8px;">
{_items(cons, "#ef4444", "✗")}
                            </div>
                        </div>"""
...
def _render_strategy_card(
    *,
    ...
    return f"""{wrapper_open}
                    ...
                    <div style="font-size:11px;color:var(--muted);margin-bottom:16px;">{subtitle}</div>
...
{getvocal_card}
                ...
                <div class="strategy-alert-card" style="border-color: rgba(255,255,255,0.15);">
                    <div class="strategy-label" style="color: var(--muted);">Блокери</div>
...
<svg viewBox="155 75 2890 1310" xmlns="http://www.w3.org/2000/svg"
     preserveAspectRatio="xMidYMid meet" style="background:var(--bg);">
      <defs>
      ...
      <text transform="translate(173,180) rotate(-90)" text-anchor="middle" font-family="JetBrains Mono,monospace" font-size="16" fill="#3d4260">Клієнт</text>
      ...
      <text transform="translate(173,350) rotate(-90)" text-anchor="middle" font-family="JetBrains Mono,monospace" font-size="15" fill="#2a5a80">Телефонія \ IVR</text>
      ...
      <text transform="translate(173,545) rotate(-90)" text-anchor="middle" font-family="JetBrains Mono,monospace" font-size="15" fill="#2a7a3a">EVA (лише Україна)</text>
      ...
      <text transform="translate(173,800) rotate(-90)" text-anchor="middle" font-family="JetBrains Mono,monospace" font-size="15" fill="#3d4260">Запис (MP3)</text>
      ...
      <text transform="translate(173,1035) rotate(-90)" text-anchor="middle" font-family="JetBrains Mono,monospace" font-size="16" fill="#b04020">Оператор</text>
      ...
      <text transform="translate(173,1257) rotate(-90)" text-anchor="middle" font-family="JetBrains Mono,monospace" font-size="15" fill="#b04020">Робоче місце оператора \ CRM</text>
      ...
      <text x="716" y="551" font-family="JetBrains Mono,monospace" font-size="14" fill="#2a8a40">Так</text>
      <!-- gateway → передати оператору (Ні) -->
      <path d="M735,600 L910,600" stroke="#1a6a30" stroke-width="1.5" fill="none" marker-end="url(#aGrn)"/>
      <text x="820" y="592" font-family="JetBrains Mono,monospace" font-size="14" fill="#2a8a40">Ні</text>
      ...
      <text x="2450" y="742" font-family="JetBrains Mono,monospace" font-size="14" fill="#1a5a8a">EVA (лише Україна)</text>
      <!-- збереження → end EVA -->
      ...
      <text x="2340" y="808" font-family="JetBrains Mono,monospace" font-size="14" fill="#4a5a70">Оператор</text>
      ...
      <text x="1949" y="1032" font-family="JetBrains Mono,monospace" font-size="14" fill="#e8834a">Так</text>
      ...
      <text x="1796" y="1116" font-family="JetBrains Mono,monospace" font-size="14" fill="#7a3010">Ні</text>
      ...
      <text x="350" y="197" text-anchor="middle" font-family="-apple-system,BlinkMacSystemFont,sans-serif" font-size="14" fill="#7a8aaa">Здійснює</text>
      <text x="350" y="211" text-anchor="middle" font-family="-apple-system,BlinkMacSystemFont,sans-serif" font-size="14" fill="#7a8aaa">дзвінок</text>
      <!-- описує запит -->
      <rect x="1300" y="160" width="100" height="80" rx="5" fill="#13161f" stroke="#3a4060" stroke-width="1.5"/>
      <text x="1350" y="204" text-anchor="middle" font-family="-apple-system,BlinkMacSystemFont,sans-serif" font-size="14" fill="#7a8aaa">Описує запит</text>
      <!-- завершує дзвінок -->
      <rect x="2030" y="160" width="100" height="80" rx="5" fill="#13161f" stroke="#3a4060" stroke-width="1.5"/>
      <text x="2080" y="197" text-anchor="middle" font-family="-apple-system,BlinkMacSystemFont,sans-serif" font-size="14" fill="#7a8aaa">Завершує</text>
      <text x="2080" y="211" text-anchor="middle" font-family="-apple-system,BlinkMacSystemFont,sans-serif" font-size="14" fill="#7a8aaa">дзвінок</text>

      <!-- ── ТЕЛЕФОНІЯ (Cisco blue) ── -->
      <rect x="300"  y="310" width="100" height="80" rx="5" fill="rgba(42,90,128,.15)" stroke="#2a5a80" stroke-width="1.5"/>
      <text x="350"  y="344" text-anchor="middle" font-family="-apple-system,BlinkMacSystemFont,sans-serif" font-size="12" fill="#5080a0">Маршрутизує</text>
      <text x="350"  y="358" text-anchor="middle" font-family="-apple-system,BlinkMacSystemFont,sans-serif" font-size="12" fill="#5080a0">дзвінок</text>

      <!-- вибір мови — EUROPE YELLOW -->
      <rect x="660"  y="310" width="100" height="80" rx="5" fill="rgba(140,120,0,.12)" stroke="#8a7a10" stroke-width="1.5"/>
      <text x="710"  y="333" text-anchor="middle" font-family="-apple-system,BlinkMacSystemFont,sans-serif" font-size="12" fill="#aa9820">(лише Європа)</text>
      <text x="710"  y="347" text-anchor="middle" font-family="-apple-system,BlinkMacSystemFont,sans-serif" font-size="14" fill="#c0b030">Вибір мови</text>
      <text x="710"  y="361" text-anchor="middle" font-family="-apple-system,BlinkMacSystemFont,sans-serif" font-size="14" fill="#c0b030">розмови</text>

      <rect x="910"  y="310" width="100" height="80" rx="5" fill="rgba(42,90,128,.15)" stroke="#2a5a80" stroke-width="1.5"/>
      <text x="960"  y="344" text-anchor="middle" font-family="-apple-system,BlinkMacSystemFont,sans-serif" font-size="14" fill="#5080a0">Очікування</text>
      <text x="960"  y="358" text-anchor="middle" font-family="-apple-system,BlinkMacSystemFont,sans-serif" font-size="14" fill="#5080a0">в черзі</text>

      <rect x="1120" y="310" width="100" height="80" rx="5" fill="rgba(42,90,128,.15)" stroke="#2a5a80" stroke-width="1.5"/>
      <text x="1170" y="341" text-anchor="middle" font-family="-apple-system,BlinkMacSystemFont,sans-serif" font-size="12" fill="#5080a0">Переадресація</text>
      <text x="1170" y="355" text-anchor="middle" font-family="-apple-system,BlinkMacSystemFont,sans-serif" font-size="12" fill="#5080a0">на оператора</text>

      <!-- ── EVA (UKRAINE GREEN) ── -->
      <rect x="450"  y="560" width="100" height="80" rx="5" fill="rgba(20,90,40,.18)" stroke="#1a6a30" stroke-width="1.5"/>
      <text x="500"  y="584" text-anchor="middle" font-family="-apple-system,BlinkMacSystemFont,sans-serif" font-size="12" fill="#3aaa50">Первинна</text>
      <text x="500"  y="597" text-anchor="middle" font-family="-apple-system,BlinkMacSystemFont,sans-serif" font-size="12" fill="#3aaa50">консультація:</text>
      <text x="500"  y="610" text-anchor="middle" font-family="-apple-system,BlinkMacSystemFont,sans-serif" font-size="12" fill="#3aaa50">трекінг \ графік</text>
      ...
      <text x="710"  y="605" text-anchor="middle" font-family="-apple-system,BlinkMacSystemFont,sans-serif" font-size="17" fill="#1a6a30">✕</text>
      <text x="710" y="643" text-anchor="middle" font-family="-apple-system,BlinkMacSystemFont,sans-serif" font-size="12" fill="#2a7a40">Чи вирішено</text>
      <text x="710" y="657" text-anchor="middle" font-family="-apple-system,BlinkMacSystemFont,sans-serif" font-size="12" fill="#2a7a40">запит клієнта?</text>

      <rect x="660"  y="440" width="100" height="80" rx="5" fill="rgba(20,90,40,.18)" stroke="#1a6a30" stroke-width="1.5"/>
      <text x="710"  y="474" text-anchor="middle" font-family="-apple-system,BlinkMacSystemFont,sans-serif" font-size="14" fill="#3aaa50">Очікування</text>
      <text x="710"  y="488" text-anchor="middle" font-family="-apple-system,BlinkMacSystemFont,sans-serif" font-size="14" fill="#3aaa50">інших питань</text>

      <rect x="910"  y="560" width="100" height="80" rx="5" fill="rgba(20,90,40,.18)" stroke="#1a6a30" stroke-width="1.5"/>
      <text x="960"  y="584" text-anchor="middle" font-family="-apple-system,BlinkMacSystemFont,sans-serif" font-size="12" fill="#3aaa50">Передати</text>
      <text x="960"  y="598" text-anchor="middle" font-family="-apple-system,BlinkMacSystemFont,sans-serif" font-size="12" fill="#3aaa50">запит</text>
      <text x="960"  y="612" text-anchor="middle" font-family="-apple-system,BlinkMacSystemFont,sans-serif" font-size="12" fill="#3aaa50">оператору</text>

      <!-- ── ЗАПИС ── -->
      <rect x="300"  y="710" width="100" height="80" rx="5" fill="#13161f" stroke="#3a4060" stroke-width="1.5"/>
      <text x="350"  y="740" text-anchor="middle" font-family="-apple-system,BlinkMacSystemFont,sans-serif" font-size="12" fill="#6a7a9a">Початок</text>
      <text x="350"  y="754" text-anchor="middle" font-family="-apple-system,BlinkMacSystemFont,sans-serif" font-size="12" fill="#6a7a9a">запису</text>
      <text x="350"  y="768" text-anchor="middle" font-family="-apple-system,BlinkMacSystemFont,sans-serif" font-size="12" fill="#6a7a9a">розмови</text>

      <rect x="2140" y="710" width="100" height="80" rx="5" fill="#13161f" stroke="#3a4060" stroke-width="1.5"/>
      <text x="2190" y="737" text-anchor="middle" font-family="-apple-system,BlinkMacSystemFont,sans-serif" font-size="12" fill="#6a7a9a">Завершення</text>
      <text x="2190" y="751" text-anchor="middle" font-family="-apple-system,BlinkMacSystemFont,sans-serif" font-size="12" fill="#6a7a9a">запису</text>
      <text x="2190" y="765" text-anchor="middle" font-family="-apple-system,BlinkMacSystemFont,sans-serif" font-size="12" fill="#6a7a9a">розмови</text>
      ...
      <text x="2330" y="754" text-anchor="middle" font-family="-apple-system,BlinkMacSystemFont,sans-serif" font-size="17" fill="#3a4060">✕</text>
      <text x="2330" y="696" text-anchor="middle" font-family="-apple-system,BlinkMacSystemFont,sans-serif" font-size="12" fill="#3a4060">Визначення</text>
      <text x="2330" y="710" text-anchor="middle" font-family="-apple-system,BlinkMacSystemFont,sans-serif" font-size="12" fill="#3a4060">каналу</text>
      <text x="2330" y="724" text-anchor="middle" font-family="-apple-system,BlinkMacSystemFont,sans-serif" font-size="12" fill="#3a4060">консультації</text>
      ...
      <text x="2810" y="737" text-anchor="middle" font-family="-apple-system,BlinkMacSystemFont,sans-serif" font-size="12" fill="#3aaa50">Збереження</text>
      <text x="2810" y="751" text-anchor="middle" font-family="-apple-system,BlinkMacSystemFont,sans-serif" font-size="12" fill="#3aaa50">запису</text>
      <text x="2810" y="765" text-anchor="middle" font-family="-apple-system,BlinkMacSystemFont,sans-serif" font-size="12" fill="#3aaa50">у Omilia</text>
      ...
      <text x="2330" y="855" text-anchor="middle" font-family="-apple-system,BlinkMacSystemFont,sans-serif" font-size="12" fill="#6a7a9a">Фіксація</text>
      <text x="2330" y="869" text-anchor="middle" font-family="-apple-system,BlinkMacSystemFont,sans-serif" font-size="12" fill="#6a7a9a">запиту</text>
      <text x="2330" y="883" text-anchor="middle" font-family="-apple-system,BlinkMacSystemFont,sans-serif" font-size="12" fill="#6a7a9a">оператором</text>

      <!-- ── ОПЕРАТОР (RED/ORANGE) ── -->
      <rect x="1280" y="1000" width="100" height="80" rx="5" fill="rgba(160,50,10,.14)" stroke="#9a3a10" stroke-width="1.5"/>
      <text x="1330" y="1030" text-anchor="middle" font-family="-apple-system,BlinkMacSystemFont,sans-serif" font-size="12" fill="#d06030">Приймає дзвінок,</text>
      <text x="1330" y="1046" text-anchor="middle" font-family="-apple-system,BlinkMacSystemFont,sans-serif" font-size="12" fill="#d06030">починає розмову</text>

      <rect x="1460" y="1000" width="100" height="80" rx="5" fill="rgba(160,50,10,.14)" stroke="#9a3a10" stroke-width="1.5"/>
      <text x="1510" y="1016" text-anchor="middle" font-family="-apple-system,BlinkMacSystemFont,sans-serif" font-size="12" fill="#d06030">Аналіз запитань,</text>
      <text x="1510" y="1030" text-anchor="middle" font-family="-apple-system,BlinkMacSystemFont,sans-serif" font-size="12" fill="#d06030">пошук у базі</text>
      <text x="1510" y="1044" text-anchor="middle" font-family="-apple-system,BlinkMacSystemFont,sans-serif" font-size="12" fill="#d06030">знань,</text>
      <text x="1510" y="1058" text-anchor="middle" font-family="-apple-system,BlinkMacSystemFont,sans-serif" font-size="12" fill="#d06030">накладної</text>

      <rect x="1650" y="1000" width="100" height="80" rx="5" fill="rgba(160,50,10,.14)" stroke="#9a3a10" stroke-width="1.5"/>
      <text x="1700" y="1033" text-anchor="middle" font-family="-apple-system,BlinkMacSystemFont,sans-serif" font-size="12" fill="#d06030">Консультує та</text>
      <text x="1700" y="1047" text-anchor="middle" font-family="-apple-system,BlinkMacSystemFont,sans-serif" font-size="12" fill="#d06030">шукає рішення</text>
      ...
      <text x="1900" y="1044" text-anchor="middle" font-family="-apple-system,BlinkMacSystemFont,sans-serif" font-size="17" fill="#9a3a10">✕</text>
      <text x="1900" y="984" text-anchor="middle" font-family="-apple-system,BlinkMacSystemFont,sans-serif" font-size="12" fill="#8a3a20">Клієнт</text>
      <text x="1900" y="998" text-anchor="middle" font-family="-apple-system,BlinkMacSystemFont,sans-serif" font-size="12" fill="#8a3a20">задоволений</text>
      <text x="1900" y="1012" text-anchor="middle" font-family="-apple-system,BlinkMacSystemFont,sans-serif" font-size="12" fill="#8a3a20">відповіддю?</text>

      <rect x="2030" y="1000" width="100" height="80" rx="5" fill="rgba(160,50,10,.14)" stroke="#9a3a10" stroke-width="1.5"/>
      <text x="2080" y="1016" text-anchor="middle" font-family="-apple-system,BlinkMacSystemFont,sans-serif" font-size="12" fill="#d06030">Очікування</text>
      <text x="2080" y="1030" text-anchor="middle" font-family="-apple-system,BlinkMacSystemFont,sans-serif" font-size="12" fill="#d06030">інших питань</text>
      <text x="2080" y="1044" text-anchor="middle" font-family="-apple-system,BlinkMacSystemFont,sans-serif" font-size="12" fill="#d06030">чи завершення</text>
      <text x="2080" y="1058" text-anchor="middle" font-family="-apple-system,BlinkMacSystemFont,sans-serif" font-size="12" fill="#d06030">дзвінка</text>

      <rect x="2420" y="1000" width="100" height="80" rx="5" fill="rgba(160,50,10,.14)" stroke="#9a3a10" stroke-width="1.5"/>
      <text x="2470" y="1016" text-anchor="middle" font-family="-apple-system,BlinkMacSystemFont,sans-serif" font-size="12" fill="#d06030">Заповнення</text>
      <text x="2470" y="1030" text-anchor="middle" font-family="-apple-system,BlinkMacSystemFont,sans-serif" font-size="12" fill="#d06030">резюме,</text>
      <text x="2470" y="1044" text-anchor="middle" font-family="-apple-system,BlinkMacSystemFont,sans-serif" font-size="12" fill="#d06030">запиту на інші</text>
      <text x="2470" y="1058" text-anchor="middle" font-family="-apple-system,BlinkMacSystemFont,sans-serif" font-size="12" fill="#d06030">відділи</text>

      <rect x="2580" y="1000" width="100" height="80" rx="5" fill="rgba(160,50,10,.14)" stroke="#9a3a10" stroke-width="1.5"/>
      <text x="2630" y="1023" text-anchor="middle" font-family="-apple-system,BlinkMacSystemFont,sans-serif" font-size="12" fill="#d06030">Заповнення</text>
      <text x="2630" y="1037" text-anchor="middle" font-family="-apple-system,BlinkMacSystemFont,sans-serif" font-size="12" fill="#d06030">тематик, тегів,</text>
      <text x="2630" y="1051" text-anchor="middle" font-family="-apple-system,BlinkMacSystemFont,sans-serif" font-size="12" fill="#d06030">тону дзвінка</text>

      <rect x="2760" y="1000" width="100" height="80" rx="5" fill="rgba(160,50,10,.14)" stroke="#9a3a10" stroke-width="1.5"/>
      <text x="2810" y="1033" text-anchor="middle" font-family="-apple-system,BlinkMacSystemFont,sans-serif" font-size="12" fill="#d06030">Тегування та</text>
      <text x="2810" y="1047" text-anchor="middle" font-family="-apple-system,BlinkMacSystemFont,sans-serif" font-size="12" fill="#d06030">маркування</text>

      <!-- ── CRM (RED/ORANGE) ── -->
      <rect x="1460" y="1240" width="100" height="80" rx="5" fill="rgba(150,45,10,.14)" stroke="#9a3a10" stroke-width="1.5"/>
      <text x="1510" y="1270" text-anchor="middle" font-family="-apple-system,BlinkMacSystemFont,sans-serif" font-size="12" fill="#c05828">Аналіз</text>
      <text x="1510" y="1284" text-anchor="middle" font-family="-apple-system,BlinkMacSystemFont,sans-serif" font-size="12" fill="#c05828">історії клієнта</text>

      <rect x="2280" y="1230" width="100" height="80" rx="5" fill="rgba(150,45,10,.14)" stroke="#9a3a10" stroke-width="1.5"/>
      <text x="2330" y="1255" text-anchor="middle" font-family="-apple-system,BlinkMacSystemFont,sans-serif" font-size="12" fill="#c05828">Створення</text>
      <text x="2330" y="1269" text-anchor="middle" font-family="-apple-system,BlinkMacSystemFont,sans-serif" font-size="12" fill="#c05828">нової картки</text>
      <text x="2330" y="1283" text-anchor="middle" font-family="-apple-system,BlinkMacSystemFont,sans-serif" font-size="12" fill="#c05828">звернення</text>

      <rect x="2760" y="1230" width="100" height="80" rx="5" fill="rgba(150,45,10,.14)" stroke="#9a3a10" stroke-width="1.5"/>
      <text x="2810" y="1260" text-anchor="middle" font-family="-apple-system,BlinkMacSystemFont,sans-serif" font-size="12" fill="#c05828">Закриття</text>
      <text x="2810" y="1274" text-anchor="middle" font-family="-apple-system,BlinkMacSystemFont,sans-serif" font-size="12" fill="#c05828">картки</text>
      ...
      <div class="section" style="border-bottom:none;">
        ...
        <div class="sys-table">
          ...
          <div class="sys-row">
            ...
            <div class="sc ua">
              <div style="margin-bottom:8px;"><span class="badge b-warn">CRM стара</span> <span style="font-size:12px;color:var(--muted);">— додатковий спосіб отримувати дані (Міжнародний відділ)</span></div>
              <div><span class="badge b-warn">Cargos</span> <span style="font-size:12px;color:var(--muted);">— інформаційний ресурс; дані йдуть в AWIS</span></div>
            </div>
            <div class="sc eu">
              <div style="margin-bottom:6px;"><span class="badge b-sys">Creatio</span> <span style="font-size:12px;color:var(--muted);">— диспетчеризація</span></div>
              <div style="margin-bottom:6px;"><span class="badge b-sys">Excel</span> <span style="font-size:12px;color:var(--muted);">— відділення в країнах</span></div>
              <div><span class="badge b-sys">Калькулятор</span> <span style="font-size:12px;color:var(--muted);">— комп'ютерний</span></div>
            </div>
          </div>
...
def generate_tobe_tab() -> str:
    ...
    <div id="p-to" class="panel tab-content" data-content="tobe">
      <div class="hero">
        <div>
          <h2 style="color:var(--ai)">TO-BE &mdash; <span style="color:var(--text)">Процес з AI Асистентом</span></h2>
          <p>6 учасників: Клієнт · Cisco (нова гілка) · Запис (MP3) · AI Асистент (4 транзакції) · Оператор · Робоче місце</p>
        </div>
        <div class="chips">
          <div class="chip" style="border-color:var(--ai-b);color:var(--ai)">Pre-AI: RAG + ЕН</div>
          <div class="chip" style="border-color:var(--ai-b);color:var(--ai)">Real-time Copilot</div>
          <div class="chip" style="border-color:var(--ai-b);color:var(--ai)">Post-call &le;1хв</div>
          <div class="chip" style="border-color:var(--ai-b);color:var(--ai)">Deep Analysis &le;10хв</div>
        </div>
      </div>
    ...
    <defs>
      <marker id="ah_s" markerWidth="6" markerHeight="6" refX="9" refY="3" orient="auto">
        <path d="M0,1 L9,5 L0,9 Z" fill="#3a4060"/>
      </marker>
      <marker id="ah_m" markerWidth="6" markerHeight="6" refX="9" refY="3" orient="auto">
        <path d="M0,1 L9,5 L0,9 Z" fill="#2a2f45"/>
      </marker>
      <marker id="ah_n" markerWidth="6" markerHeight="6" refX="9" refY="3" orient="auto">
        <path d="M0,1 L9,5 L0,9 Z" fill="#0c4020"/>
      </marker>
      <pattern id="grid3" x="0" y="0" width="20" height="20" patternUnits="userSpaceOnUse">
        <circle cx="1" cy="1" r="0.8" fill="#1a1d2a"/>
      </pattern>
    </defs>
    <rect x="-4" y="-4" width="3148" height="1268" fill="url(#grid3)"/>
    <rect x="0.0" y="0.0" width="3140.0" height="160.0" fill="#0d1320" stroke="#1a2540" stroke-width="1.2"/><rect x="0.0" y="0.0" width="30" height="160.0" fill="#0d1320" stroke="#1a2540" stroke-width="1.2"/><text transform="rotate(-90,15.0,80.0)" x="15.0" y="80.0" text-anchor="middle" dominant-baseline="middle" font-size="12" fill="#3d4260" font-family="JetBrains Mono,monospace" font-weight="600">Клієнт</text>
    <rect x="0.0" y="160.0" width="3140.0" height="230.0" fill="#090f18" stroke="#1a2540" stroke-width="1.2"/><rect x="0.0" y="160.0" width="30" height="230.0" fill="#090f18" stroke="#1a2540" stroke-width="1.2"/><text transform="rotate(-90,15.0,275.0)" x="15.0" y="275.0" text-anchor="middle" dominant-baseline="middle" font-size="12" fill="#2a5a80" font-family="JetBrains Mono,monospace" font-weight="600">Cisco</text>
    <rect x="0.0" y="390.0" width="3140.0" height="160.0" fill="#0d0f18" stroke="#1a2540" stroke-width="1.2"/><rect x="0.0" y="390.0" width="30" height="160.0" fill="#0d0f18" stroke="#1a2540" stroke-width="1.2"/><text transform="rotate(-90,15.0,470.0)" x="15.0" y="465.0" text-anchor="middle" dominant-baseline="middle" font-size="12" fill="#3d4260" font-family="JetBrains Mono,monospace" font-weight="600">Запис</text><text transform="rotate(-90,15.0,470.0)" x="15.0" y="475.0" text-anchor="middle" dominant-baseline="middle" font-size="12" fill="#3d4260" font-family="JetBrains Mono,monospace" font-weight="600">(MP3)</text>
    <rect x="0.0" y="550.0" width="3140.0" height="350.0" fill="#030f08" stroke="#1a2540" stroke-width="1.2"/><rect x="0.0" y="550.0" width="30" height="350.0" fill="#030f08" stroke="#1a2540" stroke-width="1.2"/><text transform="rotate(-90,15.0,725.0)" x="15.0" y="720.0" text-anchor="middle" dominant-baseline="middle" font-size="12" fill="#30d890" font-family="JetBrains Mono,monospace" font-weight="600">AI</text><text transform="rotate(-90,15.0,725.0)" x="15.0" y="730.0" text-anchor="middle" dominant-baseline="middle" font-size="12" fill="#30d890" font-family="JetBrains Mono,monospace" font-weight="600">Асистент</text>
    <rect x="0.0" y="900.0" width="3140.0" height="210.0" fill="#140e08" stroke="#1a2540" stroke-width="1.2"/><rect x="0.0" y="900.0" width="30" height="210.0" fill="#140e08" stroke="#1a2540" stroke-width="1.2"/><text transform="rotate(-90,15.0,1005.0)" x="15.0" y="1005.0" text-anchor="middle" dominant-baseline="middle" font-size="12" fill="#b04020" font-family="JetBrains Mono,monospace" font-weight="600">Оператор</text>
    <rect x="0.0" y="1110.0" width="3140.0" height="150.0" fill="#130e09" stroke="#1a2540" stroke-width="1.2"/><rect x="0.0" y="1110.0" width="30" height="150.0" fill="#130e09" stroke="#1a2540" stroke-width="1.2"/><text transform="rotate(-90,15.0,1185.0)" x="15.0" y="1185.0" text-anchor="middle" dominant-baseline="middle" font-size="12" fill="#b04020" font-family="JetBrains Mono,monospace" font-weight="600">CRM</text>
    <rect x="440.0" y="570.0" width="830.0" height="310.0" rx="6" fill="#020a04" stroke="#0c3820" stroke-width="1.5" stroke-dasharray="7,5"/>
    <text x="855.0" y="582.0" text-anchor="middle" font-size="12" fill="#30d890" font-family="JetBrains Mono,monospace" font-weight="600" opacity="0.8">Pre AI Assistant</text>
    <rect x="1410.0" y="570.0" width="330.0" height="310.0" rx="6" fill="#020a04" stroke="#0c3820" stroke-width="1.5" stroke-dasharray="7,5"/>
    <text x="1575.0" y="582.0" text-anchor="middle" font-size="12" fill="#30d890" font-family="JetBrains Mono,monospace" font-weight="600" opacity="0.8">Real-time AI</text>
    <text x="1575.0" y="593.0" text-anchor="middle" font-size="12" fill="#30d890" font-family="JetBrains Mono,monospace" font-weight="600" opacity="0.8">Copilot</text>
    <rect x="1990.0" y="570.0" width="480.0" height="310.0" rx="6" fill="#020a04" stroke="#0c3820" stroke-width="1.5" stroke-dasharray="7,5"/>
    <text x="2230.0" y="582.0" text-anchor="middle" font-size="12" fill="#30d890" font-family="JetBrains Mono,monospace" font-weight="600" opacity="0.8">Post-call AI (≤1m)</text>
    <rect x="2540.0" y="570.0" width="580.0" height="310.0" rx="6" fill="#020a04" stroke="#0c3820" stroke-width="1.5" stroke-dasharray="7,5"/>
    <text x="2830.0" y="582.0" text-anchor="middle" font-size="12" fill="#30d890" font-family="JetBrains Mono,monospace" font-weight="600" opacity="0.8">Deep Analysis</text>
    <text x="2830.0" y="593.0" text-anchor="middle" font-size="12" fill="#30d890" font-family="JetBrains Mono,monospace" font-weight="600" opacity="0.8">(≤10m)</text>
    <path d="M88.0,80.0 L140.0,80.0" fill="none" stroke="#3a4060" stroke-width="1.5" marker-end="url(#ah_s)"/>
    <path d="M210.0,280.0 L210.0,310.0 L285.0,310.0" fill="none" stroke="#3a4060" stroke-width="1.5" marker-end="url(#ah_s)"/>
    <path d="M335.0,310.0 L920.0,310.0" fill="none" stroke="#3a4060" stroke-width="1.5" marker-end="url(#ah_s)"/><text x="390.0" y="299.0" font-size="13" fill="#c8a030" font-family="JetBrains Mono,monospace" font-weight="600" text-anchor="middle">Так</text>
    <path d="M310.0,285.0 L310.0,230.0 L420.0,230.0" fill="none" stroke="#3a4060" stroke-width="1.5" marker-end="url(#ah_s)"/><text x="389.5" y="219.0" font-size="13" fill="#c8a030" font-family="JetBrains Mono,monospace" font-weight="600" text-anchor="middle">Ні</text>
    <path d="M620.0,1190.0 L920.0,1190.0" fill="none" stroke="#3a4060" stroke-width="1.5" marker-end="url(#ah_s)"/>
    <path d="M1020.0,1190.0 L2340.0,1190.0" fill="none" stroke="#3a4060" stroke-width="1.5" marker-end="url(#ah_s)"/>
    <path d="M2440.0,1190.0 L2570.0,1190.0" fill="none" stroke="#3a4060" stroke-width="1.5" marker-end="url(#ah_s)"/>
    <path d="M1825.0,1010.0 L1900.0,1010.0" fill="none" stroke="#3a4060" stroke-width="1.5" marker-end="url(#ah_s)"/><text x="1863.0" y="999.0" font-size="13" fill="#c8a030" font-family="JetBrains Mono,monospace" font-weight="600" text-anchor="middle">Так</text>
    <path d="M1710.0,1010.0 L1775.0,1010.0" fill="none" stroke="#3a4060" stroke-width="1.5" marker-end="url(#ah_s)"/>
    <path d="M1800.0,1035.0 L1800.0,1090.0 L1660.0,1090.0 L1660.0,1050.0" fill="none" stroke="#3a4060" stroke-width="1.5" marker-end="url(#ah_s)"/><text x="1730.5" y="1079.0" font-size="13" fill="#c8a030" font-family="JetBrains Mono,monospace" font-weight="600" text-anchor="middle">Ні</text>
    <path d="M710.0,755.0 L710.0,820.0 L920.0,820.0" fill="none" stroke="#3a4060" stroke-width="1.5" marker-end="url(#ah_s)"/><text x="725.0" y="791.0" font-size="13" fill="#c8a030" font-family="JetBrains Mono,monospace" font-weight="600" text-anchor="middle">Так</text>
    <path d="M970.0,780.0 L970.0,755.0" fill="none" stroke="#3a4060" stroke-width="1.5" marker-end="url(#ah_s)"/>
    <path d="M995.0,730.0 L1120.0,730.0" fill="none" stroke="#3a4060" stroke-width="1.5" marker-end="url(#ah_s)"/><text x="1058.0" y="719.0" font-size="13" fill="#c8a030" font-family="JetBrains Mono,monospace" font-weight="600" text-anchor="middle">Так</text>
    <path d="M710.0,705.0 L710.0,630.0 L920.0,630.0" fill="none" stroke="#3a4060" stroke-width="1.5" marker-end="url(#ah_s)"/><text x="725.5" y="672.0" font-size="13" fill="#c8a030" font-family="JetBrains Mono,monospace" font-weight="600" text-anchor="middle">Ні</text>
    <path d="M970.0,705.0 L970.0,670.0" fill="none" stroke="#3a4060" stroke-width="1.5" marker-end="url(#ah_s)"/><text x="979.5" y="692.0" font-size="13" fill="#c8a030" font-family="JetBrains Mono,monospace" font-weight="600" text-anchor="middle">Ні</text>
    <path d="M600.0,730.0 L685.0,730.0" fill="none" stroke="#3a4060" stroke-width="1.5" marker-end="url(#ah_s)"/>
    <path d="M1550.0,730.0 L1600.0,730.0" fill="none" stroke="#3a4060" stroke-width="1.5" marker-end="url(#ah_s)"/>
    <path d="M2120.0,730.0 L2180.0,730.0" fill="none" stroke="#3a4060" stroke-width="1.5" marker-end="url(#ah_s)"/>
    <path d="M2280.0,730.0 L2340.0,730.0" fill="none" stroke="#3a4060" stroke-width="1.5" marker-end="url(#ah_s)"/>
    <path d="M2670.0,725.0 L2740.0,725.0" fill="none" stroke="#3a4060" stroke-width="1.5" marker-end="url(#ah_s)"/>
    <path d="M2840.0,725.0 L2900.0,725.0" fill="none" stroke="#3a4060" stroke-width="1.5" marker-end="url(#ah_s)"/>
    <path d="M3000.0,725.0 L3052.0,725.0" fill="none" stroke="#3a4060" stroke-width="1.5" marker-end="url(#ah_s)"/>
    <path d="M190.0,120.0 L190.0,200.0" fill="none" stroke="#2a2f45" stroke-width="1.5" stroke-dasharray="7,5" marker-end="url(#ah_m)"/>
    <path d="M210.0,280.0 L210.0,430.0" fill="none" stroke="#2a2f45" stroke-width="1.5" stroke-dasharray="7,5" marker-end="url(#ah_m)"/>
    <path d="M470.0,190.0 L470.0,120.0" fill="none" stroke="#2a2f45" stroke-width="1.5" stroke-dasharray="7,5" marker-end="url(#ah_m)"/>
    <path d="M1020.0,310.0 L1330.0,310.0 L1330.0,970.0" fill="none" stroke="#2a2f45" stroke-width="1.5" stroke-dasharray="7,5" marker-end="url(#ah_m)"/>
    <path d="M970.0,590.0 L970.0,350.0" fill="none" stroke="#2a2f45" stroke-width="1.5" stroke-dasharray="7,5" marker-end="url(#ah_m)"/>
    <path d="M1170.0,690.0 L1170.0,80.0 L1900.0,80.0" fill="none" stroke="#2a2f45" stroke-width="1.5" stroke-dasharray="7,5" marker-end="url(#ah_m)"/>
    <path d="M1650.0,770.0 L1650.0,970.0" fill="none" stroke="#2a2f45" stroke-width="1.5" stroke-dasharray="7,5" marker-end="url(#ah_m)"/>
    <path d="M1370.0,970.0 L1370.0,730.0 L1450.0,730.0" fill="none" stroke="#2a2f45" stroke-width="1.5" stroke-dasharray="7,5" marker-end="url(#ah_m)"/>
    <path d="M2620.0,1150.0 L2620.0,765.0" fill="none" stroke="#2a2f45" stroke-width="1.5" stroke-dasharray="7,5" marker-end="url(#ah_m)"/>
    <path d="M2390.0,770.0 L2390.0,1150.0" fill="none" stroke="#2a2f45" stroke-width="1.5" stroke-dasharray="7,5" marker-end="url(#ah_m)"/>
    <path d="M2070.0,510.0 L2070.0,690.0" fill="none" stroke="#2a2f45" stroke-width="1.5" stroke-dasharray="7,5" marker-end="url(#ah_m)"/>
    <path d="M2000.0,80.0 L2070.0,80.0 L2070.0,430.0" fill="none" stroke="#2a2f45" stroke-width="1.5" stroke-dasharray="7,5" marker-end="url(#ah_m)"/>
    <path d="M1950.0,970.0 L1950.0,120.0" fill="none" stroke="#2a2f45" stroke-width="1.5" stroke-dasharray="7,5" marker-end="url(#ah_m)"/>
    <path d="M1480.0,770.0 L1480.0,1090.0 L590.0,1090.0 L590.0,1150.0" fill="none" stroke="#2a2f45" stroke-width="1.5" stroke-dasharray="7,5" marker-end="url(#ah_m)"/>
    <path d="M590.0,1150.0 L590.0,1090.0 L1480.0,1090.0 L1480.0,770.0" fill="none" stroke="#2a2f45" stroke-width="1.5" stroke-dasharray="7,5" marker-end="url(#ah_m)"/>
    <path d="M1610.0,1010.0 L1500.0,1010.0 L1500.0,770.0" fill="none" stroke="#2a2f45" stroke-width="1.5" stroke-dasharray="7,5" marker-end="url(#ah_m)"/>
    <path d="M550.0,770.0 L550.0,1150.0" fill="none" stroke="#2a2f45" stroke-width="1.5" stroke-dasharray="7,5" marker-end="url(#ah_m)"/>
    <path d="M520.0,80.0 L550.0,80.0 L550.0,690.0" fill="none" stroke="#2a2f45" stroke-width="1.5" stroke-dasharray="7,5" marker-end="url(#ah_m)"/>
    <circle cx="70.0" cy="80.0" r="18.0" fill="none" stroke="#3a4060" stroke-width="1.5"/>
    <rect x="140.0" y="40.0" width="100.0" height="80.0" rx="4" fill="#13161f" stroke="#3a4060" stroke-width="1.5"/><text x="190.0" y="78.0" text-anchor="middle" font-size="12" fill="#7a8aaa" font-family="-apple-system,BlinkMacSystemFont,sans-serif" font-weight="500">Здійснює</text><text x="190.0" y="89.0" text-anchor="middle" font-size="12" fill="#7a8aaa" font-family="-apple-system,BlinkMacSystemFont,sans-serif" font-weight="500">дзвінок</text>
    <rect x="420.0" y="40.0" width="100.0" height="80.0" rx="4" fill="#13161f" stroke="#3a4060" stroke-width="1.5"/><text x="470.0" y="83.5" text-anchor="middle" font-size="12" fill="#7a8aaa" font-family="-apple-system,BlinkMacSystemFont,sans-serif" font-weight="500">Описує запит</text>
    <rect x="1900.0" y="40.0" width="100.0" height="80.0" rx="4" fill="#13161f" stroke="#3a4060" stroke-width="1.5"/><text x="1950.0" y="78.0" text-anchor="middle" font-size="12" fill="#7a8aaa" font-family="-apple-system,BlinkMacSystemFont,sans-serif" font-weight="500">Завершує</text><text x="1950.0" y="89.0" text-anchor="middle" font-size="12" fill="#7a8aaa" font-family="-apple-system,BlinkMacSystemFont,sans-serif" font-weight="500">дзвінок</text>
    <rect x="160.0" y="200.0" width="100.0" height="80.0" rx="4" fill="rgba(42,90,128,.15)" stroke="#2a5a80" stroke-width="1.5"/><text x="210.0" y="238.0" text-anchor="middle" font-size="12" fill="#5090c8" font-family="-apple-system,BlinkMacSystemFont,sans-serif" font-weight="500">Маршрутизує</text><text x="210.0" y="249.0" text-anchor="middle" font-size="12" fill="#5090c8" font-family="-apple-system,BlinkMacSystemFont,sans-serif" font-weight="500">дзвінок</text>
    <polygon points="310.0,285.0 335.0,310.0 310.0,335.0 285.0,310.0" fill="#12100a" stroke="#6a5010" stroke-width="1.5"/><line x1="304.0" y1="304.0" x2="316.0" y2="316.0" stroke="#c8a030" stroke-width="1.2"/><line x1="316.0" y1="304.0" x2="304.0" y2="316.0" stroke="#c8a030" stroke-width="1.2"/><text x="310.0" y="345.0" text-anchor="middle" font-size="11" fill="#c8a030" font-family="JetBrains Mono,monospace" font-weight="600">Наявність</text><text x="310.0" y="355.0" text-anchor="middle" font-size="11" fill="#c8a030" font-family="JetBrains Mono,monospace" font-weight="600">вільного</text><text x="310.0" y="365.0" text-anchor="middle" font-size="11" fill="#c8a030" font-family="JetBrains Mono,monospace" font-weight="600">оператора?</text>
    <rect x="420.0" y="190.0" width="100.0" height="80.0" rx="4" fill="rgba(42,90,128,.15)" stroke="#2a5a80" stroke-width="1.5"/><text x="470.0" y="217.0" text-anchor="middle" font-size="12" fill="#5090c8" font-family="-apple-system,BlinkMacSystemFont,sans-serif" font-weight="500">Переадресація</text><text x="470.0" y="228.0" text-anchor="middle" font-size="12" fill="#5090c8" font-family="-apple-system,BlinkMacSystemFont,sans-serif" font-weight="500">на AI із</text><text x="470.0" y="239.0" text-anchor="middle" font-size="12" fill="#5090c8" font-family="-apple-system,BlinkMacSystemFont,sans-serif" font-weight="500">проханням</text><text x="470.0" y="250.0" text-anchor="middle" font-size="12" fill="#5090c8" font-family="-apple-system,BlinkMacSystemFont,sans-serif" font-weight="500">озвучити запит</text>
    <rect x="920.0" y="270.0" width="100.0" height="80.0" rx="4" fill="rgba(42,90,128,.15)" stroke="#2a5a80" stroke-width="1.5"/><text x="970.0" y="308.0" text-anchor="middle" font-size="12" fill="#5090c8" font-family="-apple-system,BlinkMacSystemFont,sans-serif" font-weight="500">Переадресація</text><text x="970.0" y="319.0" text-anchor="middle" font-size="12" fill="#5090c8" font-family="-apple-system,BlinkMacSystemFont,sans-serif" font-weight="500">на оператора</text>
    <rect x="160.0" y="430.0" width="100.0" height="80.0" rx="4" fill="rgba(42,90,128,.15)" stroke="#2a5a80" stroke-width="1.5"/><text x="210.0" y="468.0" text-anchor="middle" font-size="12" fill="#6a7a9a" font-family="-apple-system,BlinkMacSystemFont,sans-serif" font-weight="500">Початок запису</text><text x="210.0" y="479.0" text-anchor="middle" font-size="12" fill="#6a7a9a" font-family="-apple-system,BlinkMacSystemFont,sans-serif" font-weight="500">розмови</text>
    <rect x="2020.0" y="430.0" width="100.0" height="80.0" rx="4" fill="rgba(42,90,128,.15)" stroke="#2a5a80" stroke-width="1.5"/><text x="2070.0" y="468.0" text-anchor="middle" font-size="12" fill="#6a7a9a" font-family="-apple-system,BlinkMacSystemFont,sans-serif" font-weight="500">Завершення</text><text x="2070.0" y="479.0" text-anchor="middle" font-size="12" fill="#6a7a9a" font-family="-apple-system,BlinkMacSystemFont,sans-serif" font-weight="500">запису розмови</text>
    <rect x="500.0" y="690.0" width="100.0" height="80.0" rx="4" fill="#041408" stroke="#0c3820" stroke-width="1.5"/><text x="550.0" y="717.0" text-anchor="middle" font-size="12" fill="#3aaa60" font-family="-apple-system,BlinkMacSystemFont,sans-serif" font-weight="500">Аналіз запитань</text><text x="550.0" y="728.0" text-anchor="middle" font-size="12" fill="#3aaa60" font-family="-apple-system,BlinkMacSystemFont,sans-serif" font-weight="500">\ історії</text><text x="550.0" y="739.0" text-anchor="middle" font-size="12" fill="#3aaa60" font-family="-apple-system,BlinkMacSystemFont,sans-serif" font-weight="500">клієнта. Пошук</text><text x="550.0" y="750.0" text-anchor="middle" font-size="12" fill="#3aaa60" font-family="-apple-system,BlinkMacSystemFont,sans-serif" font-weight="500">RAG \ ЕН</text>
    <polygon points="710.0,705.0 735.0,730.0 710.0,755.0 685.0,730.0" fill="#12100a" stroke="#6a5010" stroke-width="1.5"/><line x1="704.0" y1="724.0" x2="716.0" y2="736.0" stroke="#c8a030" stroke-width="1.2"/><line x1="716.0" y1="724.0" x2="704.0" y2="736.0" stroke="#c8a030" stroke-width="1.2"/><text x="710.0" y="765.0" text-anchor="middle" font-size="11" fill="#c8a030" font-family="JetBrains Mono,monospace" font-weight="600">AI може надати</text><text x="710.0" y="775.0" text-anchor="middle" font-size="11" fill="#c8a030" font-family="JetBrains Mono,monospace" font-weight="600">відповідь?</text>
    <rect x="920.0" y="780.0" width="100.0" height="80.0" rx="4" fill="#13161f" stroke="#3a4060" stroke-width="1.5"/><text x="970.0" y="818.0" text-anchor="middle" font-size="12" fill="#7a8aaa" font-family="-apple-system,BlinkMacSystemFont,sans-serif" font-weight="500">Надає відповідь</text><text x="970.0" y="829.0" text-anchor="middle" font-size="12" fill="#7a8aaa" font-family="-apple-system,BlinkMacSystemFont,sans-serif" font-weight="500">клієнту</text>
    <polygon points="970.0,705.0 995.0,730.0 970.0,755.0 945.0,730.0" fill="#12100a" stroke="#6a5010" stroke-width="1.5"/><line x1="964.0" y1="724.0" x2="976.0" y2="736.0" stroke="#c8a030" stroke-width="1.2"/><line x1="976.0" y1="724.0" x2="964.0" y2="736.0" stroke="#c8a030" stroke-width="1.2"/><text x="970.0" y="765.0" text-anchor="middle" font-size="11" fill="#c8a030" font-family="JetBrains Mono,monospace" font-weight="600">Клієнт</text><text x="970.0" y="775.0" text-anchor="middle" font-size="11" fill="#c8a030" font-family="JetBrains Mono,monospace" font-weight="600">задоволений</text><text x="970.0" y="785.0" text-anchor="middle" font-size="11" fill="#c8a030" font-family="JetBrains Mono,monospace" font-weight="600">відповіддю?</text>
    <rect x="1120.0" y="690.0" width="100.0" height="80.0" rx="4" fill="#13161f" stroke="#3a4060" stroke-width="1.5"/><text x="1170.0" y="717.0" text-anchor="middle" font-size="12" fill="#7a8aaa" font-family="-apple-system,BlinkMacSystemFont,sans-serif" font-weight="500">Очікування</text><text x="1170.0" y="728.0" text-anchor="middle" font-size="12" fill="#7a8aaa" font-family="-apple-system,BlinkMacSystemFont,sans-serif" font-weight="500">інших питань чи</text><text x="1170.0" y="739.0" text-anchor="middle" font-size="12" fill="#7a8aaa" font-family="-apple-system,BlinkMacSystemFont,sans-serif" font-weight="500">завершення</text><text x="1170.0" y="750.0" text-anchor="middle" font-size="12" fill="#7a8aaa" font-family="-apple-system,BlinkMacSystemFont,sans-serif" font-weight="500">дзвінка</text>
    <rect x="920.0" y="590.0" width="100.0" height="80.0" rx="4" fill="#041408" stroke="#0c3820" stroke-width="1.5"/><text x="970.0" y="622.5" text-anchor="middle" font-size="12" fill="#3aaa60" font-family="-apple-system,BlinkMacSystemFont,sans-serif" font-weight="500">Передає</text><text x="970.0" y="633.5" text-anchor="middle" font-size="12" fill="#3aaa60" font-family="-apple-system,BlinkMacSystemFont,sans-serif" font-weight="500">контекст</text><text x="970.0" y="644.5" text-anchor="middle" font-size="12" fill="#3aaa60" font-family="-apple-system,BlinkMacSystemFont,sans-serif" font-weight="500">зібраних даних</text>
    <rect x="1450.0" y="690.0" width="100.0" height="80.0" rx="4" fill="#041408" stroke="#0c3820" stroke-width="1.5"/><text x="1500.0" y="717.0" text-anchor="middle" font-size="12" fill="#3aaa60" font-family="-apple-system,BlinkMacSystemFont,sans-serif" font-weight="500">Аналіз</text><text x="1500.0" y="728.0" text-anchor="middle" font-size="12" fill="#3aaa60" font-family="-apple-system,BlinkMacSystemFont,sans-serif" font-weight="500">запитань, пошук</text><text x="1500.0" y="739.0" text-anchor="middle" font-size="12" fill="#3aaa60" font-family="-apple-system,BlinkMacSystemFont,sans-serif" font-weight="500">у базі знань,</text><text x="1500.0" y="750.0" text-anchor="middle" font-size="12" fill="#3aaa60" font-family="-apple-system,BlinkMacSystemFont,sans-serif" font-weight="500">накладної</text>
    <rect x="1600.0" y="690.0" width="100.0" height="80.0" rx="4" fill="#041408" stroke="#0c3820" stroke-width="1.5"/><text x="1650.0" y="711.5" text-anchor="middle" font-size="12" fill="#3aaa60" font-family="-apple-system,BlinkMacSystemFont,sans-serif" font-weight="500">Висвітлення</text><text x="1650.0" y="722.5" text-anchor="middle" font-size="12" fill="#3aaa60" font-family="-apple-system,BlinkMacSystemFont,sans-serif" font-weight="500">підказок,</text><text x="1650.0" y="733.5" text-anchor="middle" font-size="12" fill="#3aaa60" font-family="-apple-system,BlinkMacSystemFont,sans-serif" font-weight="500">історії</text><text x="1650.0" y="744.5" text-anchor="middle" font-size="12" fill="#3aaa60" font-family="-apple-system,BlinkMacSystemFont,sans-serif" font-weight="500">клієнта,</text><text x="1650.0" y="755.5" text-anchor="middle" font-size="12" fill="#3aaa60" font-family="-apple-system,BlinkMacSystemFont,sans-serif" font-weight="500">найкращих дій</text>
    <rect x="2020.0" y="690.0" width="100.0" height="80.0" rx="4" fill="rgba(42,90,128,.15)" stroke="#2a5a80" stroke-width="1.5"/><text x="2070.0" y="728.0" text-anchor="middle" font-size="12" fill="#5090c8" font-family="-apple-system,BlinkMacSystemFont,sans-serif" font-weight="500">Транскрибація.</text><text x="2070.0" y="739.0" text-anchor="middle" font-size="12" fill="#5090c8" font-family="-apple-system,BlinkMacSystemFont,sans-serif" font-weight="500">Витяг сутностей</text>
    <rect x="2180.0" y="690.0" width="100.0" height="80.0" rx="4" fill="rgba(42,90,128,.15)" stroke="#2a5a80" stroke-width="1.5"/><text x="2230.0" y="717.0" text-anchor="middle" font-size="12" fill="#5090c8" font-family="-apple-system,BlinkMacSystemFont,sans-serif" font-weight="500">Генерація</text><text x="2230.0" y="728.0" text-anchor="middle" font-size="12" fill="#5090c8" font-family="-apple-system,BlinkMacSystemFont,sans-serif" font-weight="500">резюме, запиту</text><text x="2230.0" y="739.0" text-anchor="middle" font-size="12" fill="#5090c8" font-family="-apple-system,BlinkMacSystemFont,sans-serif" font-weight="500">на інші відділи</text><text x="2230.0" y="750.0" text-anchor="middle" font-size="12" fill="#5090c8" font-family="-apple-system,BlinkMacSystemFont,sans-serif" font-weight="500">(опціонально)</text>
    <rect x="2340.0" y="690.0" width="100.0" height="80.0" rx="4" fill="rgba(42,90,128,.15)" stroke="#2a5a80" stroke-width="1.5"/><text x="2390.0" y="722.5" text-anchor="middle" font-size="12" fill="#5090c8" font-family="-apple-system,BlinkMacSystemFont,sans-serif" font-weight="500">Заповнення</text><text x="2390.0" y="733.5" text-anchor="middle" font-size="12" fill="#5090c8" font-family="-apple-system,BlinkMacSystemFont,sans-serif" font-weight="500">тематик, тегів,</text><text x="2390.0" y="744.5" text-anchor="middle" font-size="12" fill="#5090c8" font-family="-apple-system,BlinkMacSystemFont,sans-serif" font-weight="500">тону дзвінка</text>
    <rect x="2570.0" y="685.0" width="100.0" height="80.0" rx="4" fill="rgba(42,90,128,.15)" stroke="#2a5a80" stroke-width="1.5"/><text x="2620.0" y="712.0" text-anchor="middle" font-size="12" fill="#5090c8" font-family="-apple-system,BlinkMacSystemFont,sans-serif" font-weight="500">Перевірка</text><text x="2620.0" y="723.0" text-anchor="middle" font-size="12" fill="#5090c8" font-family="-apple-system,BlinkMacSystemFont,sans-serif" font-weight="500">проходження</text><text x="2620.0" y="734.0" text-anchor="middle" font-size="12" fill="#5090c8" font-family="-apple-system,BlinkMacSystemFont,sans-serif" font-weight="500">оператора по</text><text x="2620.0" y="745.0" text-anchor="middle" font-size="12" fill="#5090c8" font-family="-apple-system,BlinkMacSystemFont,sans-serif" font-weight="500">чеклисту</text>
    <rect x="2740.0" y="685.0" width="100.0" height="80.0" rx="4" fill="rgba(42,90,128,.15)" stroke="#2a5a80" stroke-width="1.5"/><text x="2790.0" y="723.0" text-anchor="middle" font-size="12" fill="#5090c8" font-family="-apple-system,BlinkMacSystemFont,sans-serif" font-weight="500">Тегування та</text><text x="2790.0" y="734.0" text-anchor="middle" font-size="12" fill="#5090c8" font-family="-apple-system,BlinkMacSystemFont,sans-serif" font-weight="500">маркування</text>
    <rect x="2900.0" y="685.0" width="100.0" height="80.0" rx="4" fill="rgba(42,90,128,.15)" stroke="#2a5a80" stroke-width="1.5"/><text x="2950.0" y="717.5" text-anchor="middle" font-size="12" fill="#5090c8" font-family="-apple-system,BlinkMacSystemFont,sans-serif" font-weight="500">Інтеграція</text><text x="2950.0" y="728.5" text-anchor="middle" font-size="12" fill="#5090c8" font-family="-apple-system,BlinkMacSystemFont,sans-serif" font-weight="500">даних у</text><text x="2950.0" y="739.5" text-anchor="middle" font-size="12" fill="#5090c8" font-family="-apple-system,BlinkMacSystemFont,sans-serif" font-weight="500">аналітику BI</text>
    <circle cx="3070.0" cy="725.0" r="18.0" fill="#0b0e14" stroke="#3a4060" stroke-width="3"/><circle cx="3070.0" cy="725.0" r="14.0" fill="#3a4060"/>
    <rect x="1300.0" y="970.0" width="100.0" height="80.0" rx="4" fill="rgba(160,50,10,.14)" stroke="#9a3a10" stroke-width="1.5"/><text x="1350.0" y="1002.5" text-anchor="middle" font-size="12" fill="#d06030" font-family="-apple-system,BlinkMacSystemFont,sans-serif" font-weight="500">Приймає</text><text x="1350.0" y="1013.5" text-anchor="middle" font-size="12" fill="#d06030" font-family="-apple-system,BlinkMacSystemFont,sans-serif" font-weight="500">дзвінок,</text><text x="1350.0" y="1024.5" text-anchor="middle" font-size="12" fill="#d06030" font-family="-apple-system,BlinkMacSystemFont,sans-serif" font-weight="500">починає розмову</text><rect x="1304.0" y="974.0" width="34" height="8" rx="2" fill="#2a1200"/><text x="1321.0" y="981.0" text-anchor="middle" font-size="8.0" fill="#c05020" font-family="JetBrains Mono,monospace" font-weight="700">MANUAL</text>
    <rect x="1610.0" y="970.0" width="100.0" height="80.0" rx="4" fill="rgba(160,50,10,.14)" stroke="#9a3a10" stroke-width="1.5"/><text x="1660.0" y="997.0" text-anchor="middle" font-size="12" fill="#d06030" font-family="-apple-system,BlinkMacSystemFont,sans-serif" font-weight="500">Консультує,</text><text x="1660.0" y="1008.0" text-anchor="middle" font-size="12" fill="#d06030" font-family="-apple-system,BlinkMacSystemFont,sans-serif" font-weight="500">читаючи</text><text x="1660.0" y="1019.0" text-anchor="middle" font-size="12" fill="#d06030" font-family="-apple-system,BlinkMacSystemFont,sans-serif" font-weight="500">підказки, та</text><text x="1660.0" y="1030.0" text-anchor="middle" font-size="12" fill="#d06030" font-family="-apple-system,BlinkMacSystemFont,sans-serif" font-weight="500">шукає рішення</text><rect x="1614.0" y="974.0" width="34" height="8" rx="2" fill="#2a1200"/><text x="1631.0" y="981.0" text-anchor="middle" font-size="8.0" fill="#c05020" font-family="JetBrains Mono,monospace" font-weight="700">MANUAL</text>
    <polygon points="1800.0,985.0 1825.0,1010.0 1800.0,1035.0 1775.0,1010.0" fill="#12100a" stroke="#6a5010" stroke-width="1.5"/><line x1="1794.0" y1="1004.0" x2="1806.0" y2="1016.0" stroke="#c8a030" stroke-width="1.2"/><line x1="1806.0" y1="1004.0" x2="1794.0" y2="1016.0" stroke="#c8a030" stroke-width="1.2"/><text x="1800.0" y="948.0" text-anchor="middle" font-size="11" fill="#c8a030" font-family="JetBrains Mono,monospace" font-weight="600">Клієнт</text><text x="1800.0" y="960.0" text-anchor="middle" font-size="11" fill="#c8a030" font-family="JetBrains Mono,monospace" font-weight="600">задоволений</text><text x="1800.0" y="972.0" text-anchor="middle" font-size="11" fill="#c8a030" font-family="JetBrains Mono,monospace" font-weight="600">відповіддю?</text>
    <rect x="1900.0" y="970.0" width="100.0" height="80.0" rx="4" fill="rgba(160,50,10,.14)" stroke="#9a3a10" stroke-width="1.5"/><text x="1950.0" y="997.0" text-anchor="middle" font-size="12" fill="#d06030" font-family="-apple-system,BlinkMacSystemFont,sans-serif" font-weight="500">Очікування</text><text x="1950.0" y="1008.0" text-anchor="middle" font-size="12" fill="#d06030" font-family="-apple-system,BlinkMacSystemFont,sans-serif" font-weight="500">інших питань чи</text><text x="1950.0" y="1019.0" text-anchor="middle" font-size="12" fill="#d06030" font-family="-apple-system,BlinkMacSystemFont,sans-serif" font-weight="500">завершення</text><text x="1950.0" y="1030.0" text-anchor="middle" font-size="12" fill="#d06030" font-family="-apple-system,BlinkMacSystemFont,sans-serif" font-weight="500">дзвінка</text><rect x="1904.0" y="974.0" width="34" height="8" rx="2" fill="#2a1200"/><text x="1921.0" y="981.0" text-anchor="middle" font-size="8.0" fill="#c05020" font-family="JetBrains Mono,monospace" font-weight="700">MANUAL</text>
    <rect x="520.0" y="1150.0" width="100.0" height="80.0" rx="4" fill="rgba(42,90,128,.15)" stroke="#2a5a80" stroke-width="1.5"/><text x="570.0" y="1188.0" text-anchor="middle" font-size="12" fill="#5090c8" font-family="-apple-system,BlinkMacSystemFont,sans-serif" font-weight="500">Аналіз історії</text><text x="570.0" y="1199.0" text-anchor="middle" font-size="12" fill="#5090c8" font-family="-apple-system,BlinkMacSystemFont,sans-serif" font-weight="500">клієнта</text>
    <rect x="920.0" y="1150.0" width="100.0" height="80.0" rx="4" fill="rgba(42,90,128,.15)" stroke="#2a5a80" stroke-width="1.5"/><text x="970.0" y="1182.5" text-anchor="middle" font-size="12" fill="#5090c8" font-family="-apple-system,BlinkMacSystemFont,sans-serif" font-weight="500">Створення нової</text><text x="970.0" y="1193.5" text-anchor="middle" font-size="12" fill="#5090c8" font-family="-apple-system,BlinkMacSystemFont,sans-serif" font-weight="500">картки</text><text x="970.0" y="1204.5" text-anchor="middle" font-size="12" fill="#5090c8" font-family="-apple-system,BlinkMacSystemFont,sans-serif" font-weight="500">звернення</text>
    <rect x="2340.0" y="1150.0" width="100.0" height="80.0" rx="4" fill="rgba(150,45,10,.14)" stroke="#9a3a10" stroke-width="1.5"/><rect x="2344.0" y="1154.0" width="34" height="8" rx="2" fill="#2a1200"/><text x="2361.0" y="1161.0" text-anchor="middle" font-size="8.0" fill="#c05020" font-family="JetBrains Mono,monospace" font-weight="700">MANUAL</text><text x="2390.0" y="1188.0" text-anchor="middle" font-size="12" fill="#c05828" font-family="-apple-system,BlinkMacSystemFont,sans-serif" font-weight="500">Доповнення</text><text x="2390.0" y="1199.0" text-anchor="middle" font-size="12" fill="#c05828" font-family="-apple-system,BlinkMacSystemFont,sans-serif" font-weight="500">картки клієнта</text>
    <rect x="2570.0" y="1150.0" width="100.0" height="80.0" rx="4" fill="rgba(150,45,10,.14)" stroke="#9a3a10" stroke-width="1.5"/><rect x="2574.0" y="1154.0" width="34" height="8" rx="2" fill="#2a1200"/><text x="2591.0" y="1161.0" text-anchor="middle" font-size="8.0" fill="#c05020" font-family="JetBrains Mono,monospace" font-weight="700">MANUAL</text><text x="2620.0" y="1193.5" text-anchor="middle" font-size="12" fill="#c05828" font-family="-apple-system,BlinkMacSystemFont,sans-serif" font-weight="500">Закриття картки</text>
    </svg></div>
...
<head>
    ...
    <style>
        ...
        * {{
        ...
        .bpmn-viewer-wrap {{ position: relative; height: 600px; border: 1px solid #252e45; border-radius: 8px; margin: 0 0 24px; background: var(--card-bg); overflow: hidden; }}
        ...
        .bpmn-lead {{ font-size: 12px; color: var(--muted); line-height: 1.6; }}
        ...
        .bpmn-legend {{ display: flex; gap: 16px; flex-wrap: wrap; align-items: center; padding: 0 0 12px; font-size: 11px; color: var(--muted); }}
        ...
        .bpmn-prob-text {{ font-size: 11px; color: var(--muted); line-height: 1.6; }}
        ...
        .bpmn-benefit-text {{ font-size: 11px; color: var(--muted); line-height: 1.6; }}
        ...
        .breakdown-fill.copilot {{ background: var(--accent-text); }}
        ...
        .mth-card {{ background: var(--card-bg); border: 1px solid var(--border2); border-radius: var(--radius-card); padding: 32px; margin-top: 32px; }}
        .mth-card-title {{ font-size: 20px; font-weight: 700; color: var(--accent-text); margin-bottom: 24px; }}
        .mth-inner-divider {{ height: 1px; background: var(--border2); margin: 24px 0; }}
        .mth-sub-label {{ font-size: 11px; font-weight: 600; color: var(--muted); letter-spacing: 1.2px; text-transform: uppercase; margin-bottom: 14px; }}
        .msc-row {{ display: grid; grid-template-columns: repeat(3, 1fr); gap: 12px; }}
        .msc-item {{ background: var(--bg2); border: 1px solid var(--border2); border-radius: 10px; padding: 14px 16px; display: flex; gap: 12px; align-items: flex-start; }}
        ...
        .msc-desc {{ font-size: 12px; color: var(--muted); line-height: 1.55; }}
        ...
        .pb-name {{ font-size: 12px; color: var(--muted); white-space: nowrap; }}
        .pb-track {{ height: 5px; background: var(--border2); border-radius: 99px; overflow: hidden; }}
        ...
        .formula-box {{ background: var(--bg2); border: 1px solid var(--border2); border-radius: 10px; padding: 16px; display: flex; align-items: center; justify-content: center; height: 100%; }}
        ...
        .fm-num   {{ font-size: 11px; color: var(--muted); white-space: nowrap; padding-bottom: 3px; }}
        ...
        .scale-item {{ background: var(--bg2); border: 1px solid var(--border2); border-left: 3px solid var(--sc); border-radius: 8px; padding: 12px; display: flex; gap: 10px; align-items: flex-start; }}
        ...
        .scale-track {{ height: 3px; background: var(--border2); border-radius: 99px; margin-bottom: 6px; overflow: hidden; }}
        .scale-fill  {{ height: 100%; border-radius: 99px; background: var(--sc); }}
        .scale-desc  {{ font-size: 11px; color: var(--muted); line-height: 1.45; }}
        ...
        .hero h2{{font-size:20px;font-weight:700;line-height:1.15}}
        ...
        .bpmn-wrap{{width:100vw;position:relative;left:50%;right:50%;margin-left:-50vw;margin-right:-50vw;
          border-top:1px solid var(--border2);border-bottom:1px solid var(--border2);overflow-x:auto;background:var(--bg)}}
        .bpmn-wrap svg{{display:block;width:100%;height:auto}}
        .page-header{{padding:24px 32px 0}}
        .page-title{{font-size:20px;font-weight:700;color:var(--text);margin-bottom:6px;letter-spacing:-0.01em}}
        .page-sub{{font-size:12px;color:var(--muted);letter-spacing:0.01em}}
        #p-as .legend,#p-to .legend{{gap:8px;padding:12px 32px;margin:0}}
        #p-as .leg,#p-to .leg{{display:flex;align-items:center;gap:6px;font-size:11px;color:var(--muted);
          padding:4px 10px;border:1px solid var(--border2);border-radius:3px;background:var(--bg);
        ...
        .sec-label::before{{content:'//';color:var(--accent-text);font-weight:400}}
        .prob-grid{{display:grid;grid-template-columns:repeat(3,1fr);gap:12px}}
        .prob-card{{background:var(--warn-bg);padding:20px 22px;border:1px solid var(--warn-b);border-radius:6px}}
        .prob-title{{font-size:13px;font-weight:600;color:var(--warn);margin-bottom:8px}}
        .prob-text{{font-size:12px;color:var(--muted);line-height:1.6}}
        .sys-table{{border:1px solid var(--border2);border-radius:3px;overflow:hidden;background:var(--bg)}}
        .sys-head{{display:grid;grid-template-columns:180px 1fr 1fr;background:var(--bg);border-bottom:2px solid var(--border2)}}
        .sh{{padding:12px 18px;font-size:10px;font-weight:600;letter-spacing:0.15em;text-transform:uppercase;border-right:1px solid var(--border2)}}
        .sh:last-child{{border-right:none}}
        .sh.cat{{color:var(--muted)}}
        .sh.ua{{color:var(--accent-text)}}
        .sh.eu{{color:#e8a84a}}
        .sys-row{{display:grid;grid-template-columns:180px 1fr 1fr;border-bottom:1px solid var(--border2)}}
        .sys-row:last-child{{border-bottom:none}}
        .sc{{padding:16px 18px;border-right:1px solid var(--border2);font-size:12px;color:var(--muted);line-height:1.6}}
        .sc:last-child{{border-right:none}}
        .sc.cat{{font-size:11px;font-weight:600;color:var(--muted);background:var(--bg)}}
        .sc.ua{{border-left:2px solid var(--accent-b)}}
        ...
        .b-ok{{background:var(--ai-bg);color:var(--ai);border:1px solid var(--ai-b)}}
        ...
        .b-sys{{background:var(--accent-bg);color:var(--accent-text);border:1px solid var(--accent-b)}}
        .b-ms{{background:var(--accent-bg);color:var(--accent-text);border:1px solid var(--accent-b)}}
        ul.dl{{list-style:none;padding:0;margin:0}}
        ul.dl li{{padding-left:12px;position:relative;margin-bottom:4px;font-size:12px;color:var(--muted)}}
        ul.dl li::before{{content:'·';position:absolute;left:0;color:#2a2f45}}
        ul.dl li.bad{{color:var(--warn)}}
